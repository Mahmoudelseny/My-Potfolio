...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-20 bg-zinc-900/50 border-y border-zinc-850 relative">
      <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-indigo-500/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-mono uppercase tracking-wider">
            <Award className="w-3 h-3 text-indigo-400" /> Competencies
          </div>
            ...
            return (
              ...
              >
                  ...
                  <div className="space-y-4">
                    {catSkills.map((skill) => (
                      <div key={skill.name} className="space-y-1.5">
                        ...
                        <div className="h-1.5 w-full bg-zinc-905 bg-zinc-900 rounded-full overflow-hidden">
                          <motion.div
                ...
                <div className="pt-4 border-t border-zinc-900 flex flex-wrap gap-1.5">
                  <span className="text-[10px] font-mono font-bold text-indigo-400 bg-indigo-950/20 border border-indigo-900/30 px-2 py-0.5 rounded-md">
                    Proficient
                  </span>
                  <span className="text-[10px] font-mono font-bold text-cyan-400 bg-cyan-950/20 border border-cyan-900/30 px-2 py-0.5 rounded-md">
                    Production Tested
                  </span>
                </div>
              </motion.div>
        ...
        <div className="mt-12 bg-zinc-900/70 border border-zinc-850 p-6 rounded-2xl max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center text-left">
                    ...
                    <div className="relative w-16 h-16 flex items-center justify-center">
                      <svg className="absolute inset-0 w-full h-full transform -rotate-90">
                        ...
                        <motion.circle
                          ...
                          whileInView={{ strokeDashoffset: 175 - (175 * lang.level) / 100 }}
                          viewport={{ once: true }}
            ...
            <div className="space-y-4 border-t md:border-t-0 md:border-l border-zinc-800 pt-6 md:pt-0 md:pl-8">
              <h4 className="text-sm font-bold text-white font-mono uppercase tracking-wider text-indigo-400">
                Core Strengths
              </h4>
