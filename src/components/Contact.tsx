...
import { Mail, Phone, MapPin, Send, MessageSquare, CheckCircle, Trash2, ShieldAlert, AlertCircle } from 'lucide-react';
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-zinc-950 relative">
      <div className="absolute bottom-1/4 right-1/4 w-[350px] h-[350px] bg-indigo-500/5 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-mono uppercase tracking-wider">
            <MessageSquare className="w-3.5 h-3.5 text-indigo-400" /> Collaboration
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            <div className="bg-zinc-900/60 border border-zinc-850 p-6 rounded-2xl space-y-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="flex gap-4 items-start">
                  <span className="p-3 bg-zinc-950 border border-zinc-850 rounded-xl text-indigo-400 shrink-0">
            ...
            <div className="p-4 bg-zinc-900/30 border border-zinc-850 rounded-2xl flex flex-col items-start gap-3">
              ...
              <button
                ...
                className="text-[11px] font-mono font-bold text-indigo-400 hover:text-indigo-300 flex items-center gap-1 bg-zinc-900 hover:bg-zinc-850 border border-zinc-800 px-3 py-1 rounded-lg transition-all cursor-pointer"
              >
          ...
          <div className="lg:col-span-7 bg-zinc-900/60 border border-zinc-850 p-6 rounded-2xl text-left min-h-[360px]">
            <AnimatePresence mode="wait">
              {isSuccess ? (
                <motion.div 
                  ...
                  key="success-message"
                >
                  <div className="w-16 h-16 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 flex items-center justify-center mx-auto shadow-lg">
                  ...
                  <button
                    ...
                    className="mt-4 px-5 py-2.5 bg-zinc-800 hover:bg-zinc-755 text-white border border-zinc-700 hover:border-zinc-600 font-semibold rounded-xl text-sm transition-all cursor-pointer"
                  >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full bg-zinc-950 border rounded-xl px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none transition-all ${
                          errors.name ? 'border-red-500 focus:ring-1 focus:ring-red-500' : 'border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500'
                        }`}
                      />
                      {errors.name && (
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full bg-zinc-950 border rounded-xl px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none transition-all ${
                          errors.email ? 'border-red-500 focus:ring-1 focus:ring-red-500' : 'border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500'
                        }`}
                      />
                      {errors.email && (
                        <p className="text-[11px] text-red-500 font-mono flex items-center gap-1 mt-1">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={`w-full bg-zinc-950 border rounded-xl px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none transition-all ${
                        errors.subject ? 'border-red-500 focus:ring-1 focus:ring-red-500' : 'border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500'
                      }`}
                    />
                    {errors.subject && (
                      <p className="text-[11px] text-red-500 font-mono flex items-center gap-1 mt-1">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-zinc-950 border rounded-xl px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none transition-all ${
                        errors.message ? 'border-red-500 focus:ring-1 focus:ring-red-500' : 'border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500'
                      }`}
                    ></textarea>
                    {errors.message && (
                      <p className="text-[11px] text-red-500 font-mono flex items-center gap-1 mt-1">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-400 hover:to-violet-500 text-white font-semibold py-3.5 px-4 rounded-xl text-sm shadow-md shadow-indigo-500/10 transition-all duration-200 cursor-pointer"
                  >
                    {isSubmitting ? (
                      <>
        ...
        <AnimatePresence>
          {showAdminConsole && (
            <motion.div 
              ...
              className="mt-12 bg-zinc-900 border border-zinc-800 p-6 rounded-2xl max-w-5xl mx-auto text-left space-y-6 overflow-hidden"
            >
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-red-955 bg-red-950/20 hover:bg-red-900/30 text-red-400 disabled:opacity-50 font-mono text-[10px] font-bold uppercase tracking-wider rounded-lg border border-red-900/30 flex items-center gap-1 cursor-pointer"
                >
