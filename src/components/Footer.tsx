...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-zinc-950 border-t border-zinc-900 py-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[100px] bg-emerald-500/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-b border-zinc-900 pb-8">
          ...
          <div className="text-center md:text-left">
            <span 
              ...
              className="text-lg font-extrabold text-white tracking-tight flex items-center justify-center md:justify-start gap-2 cursor-pointer hover:text-emerald-400 transition-colors"
            >
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm font-medium text-zinc-400">
            {['hero', 'projects', 'experience', 'skills', 'blog', 'contact'].map((section) => (
              <button
                ...
                className="hover:text-emerald-400 transition-all capitalize cursor-pointer text-xs font-mono"
              >
